...
public class SoundProfileLocalDataSource implements SoundDataSource {
    ...
    public void getProfiles(int sortType, @NonNull LoadProfileCallback callback) {
        ...
        Profile soundProfile = new Profile(0, "Rogerinho", "https://pbs.twimg.com/profile_images/800701598582407168/3dKHpeEJ.jpg", 5);
        soundProfileList.add(soundProfile);
        soundProfile = new Profile(1, "Renan", "https://pbs.twimg.com/media/DTQy9Z4XcAA6yO9.jpg", 78);
        soundProfileList.add(soundProfile);
        soundProfile = new Profile(2, "Julinho", "https://pbs.twimg.com/profile_images/800892278470537216/eejoSRRh.jpg", 9);
        soundProfileList.add(soundProfile);
        soundProfile = new Profile(3, "Maurílio", "https://media.tenor.com/images/78f66e06e01627aa1720e24e2b52f16c/tenor.png", 13);
        soundProfileList.add(soundProfile);
