...
public class SoundProfileLocalDataSource implements SoundDataSource {
    ...
    public void getProfiles(int sortType, @NonNull LoadProfileCallback callback) {
        ...
        soundProfileList.add(soundProfile);
        soundProfile = new SoundProfile(2, "Julinho", "https://pbs.twimg.com/profile_images/800892278470537216/eejoSRRh.jpg", 5);
        soundProfileList.add(soundProfile);
        soundProfile = new SoundProfile(3, "Maurílio", "https://media.tenor.com/images/78f66e06e01627aa1720e24e2b52f16c/tenor.png", 5);
        soundProfileList.add(soundProfile);
